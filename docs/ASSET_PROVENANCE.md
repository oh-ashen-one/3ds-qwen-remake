...
| --- | --- | --- |
| Six-zone low-poly environment | `assets/scene_source.json` | Original scene composition; expanded offline into 723 host-test boxes and six independent `romfs/zones/*.bin` runtime blobs |
| Editable Blender scene and rigid rig | `assets/blender/ashen-rift-source.blend`, generated by `assets/blender/author_lowpoly.py` | Original 723-prop environment and 15-bone hierarchy |
...
| Player, NPC, horses, wildlife, Warden, Gore-Tusk, and Arashi geometry | Indexed runtime box mesh plus rigid hierarchy in `source/renderer.cpp` | Original code, silhouettes, and composition |
