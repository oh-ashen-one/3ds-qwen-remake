...
def main() -> None:
    ...
    require(input_source, "audio_.setZone(world.zone, world.player.position.z)",
            "zone-and-elevation music switching")
    ...
    require(audio_source, "romfs:/audio/valley_after_dawn.pcm", "field music path")
    require(audio_source, "summit_combat", "summit boss music selection")
    require(audio_source, "zone == Zone::Field", "field-zone music selection")
    ...
    require(renderer, 'world.zone == Zone::Field', "field horse-call touch control")
    ...
    require(renderer, "renderBoar", "ravine hog boss")
    require(renderer, "renderMountainOgre", "summit ogre boss")
    require(renderer, "BossState::WindupMagic", "ogre magic telegraph")
    require(renderer, "zoneGroundHeight", "mountain ascent elevation")
